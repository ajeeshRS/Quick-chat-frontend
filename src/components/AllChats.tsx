...
function AllChats() {
  return (
<div className='flex sm:w-[30%] w-4/4 sm:h-6/6 h-4/4 flex-col bg-white rounded-lg m-2 justify-between shadow-sm sm:shadow-lg'>
        ...
        <div className='flex w-full px-6 justify-between items-center pt-2 h-[10vh]'>
          ...
          <div className='flex sm:w-1/6 w-2/6 justify-between'>
            <button className='hover:bg-[#e7e7e7]   rounded-lg duration-300 p-2 transition-all ease-in-out w-full flex justify-center items-center'><Icon icon="fluent:chat-add-32-regular" width="20" height="20" /></button>
            <button className='hover:bg-[#e7e7e7]   rounded-lg duration-300 p-2 transition-all ease-in-out w-full flex justify-center items-center'><Icon icon="octicon:filter-16" width="20" height="20" /></button>
            <button className='hover:bg-[#e7e7e7]  rounded-lg duration-300 p-2 transition-all ease-in-out w-full flex justify-center items-center sm:hidden'><Icon icon="charm:menu-kebab" width="20" height="20" /></button>
          </div>
        </div>
